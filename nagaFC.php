...
<div class="">
    <div class="ads w-100" style="background-image: url(lOGO/staduim.jpg); ">
        <div class="brand_club d-flex justify-content-center">
            <img  src="lOGO/Nagaworld_FC_logo.png" height="200px" style="padding-top: 10px;" alt="">
        </div>
...
<div class="container">
    <h1 style="font-family: TeXGyreAdventor;">Nagaworld FC</h1>
    <div class="row">
    <?php
