...
<div class="">
    <div class="ads w-100" style="background-image: url(lOGO/staduim.jpg); ">
        <div class="brand_club d-flex justify-content-center">
            <img  src="lOGO/Kirivong_Sok_Sen_Chey_FC_Crest.png  " height="200px" style="padding-top: 10px;" alt="">
        </div>
...
<div class="container">
    <h1 style="font-family: TeXGyreAdventor;">Kirivong Sok Senchey</h1>
    <div class="row">
    <?php
    ...
    WHERE p.brand='Kirivong Sok Senchey'
    ";
